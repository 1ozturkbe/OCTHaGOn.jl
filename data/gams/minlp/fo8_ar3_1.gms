...
e61..  - 0.433013*x76 - 0.144338*x78 =L= -2;

e62..  - 0.144338*x76 - 0.433013*x78 =L= -2;

e63..  - 0.433013*x77 - 0.144338*x79 =L= -2;

e64..  - 0.144338*x77 - 0.433013*x79 =L= -2;

e65..  - 0.433013*x80 - 0.144338*x82 =L= -2;

e66..  - 0.144338*x80 - 0.433013*x82 =L= -2;

e67..  - 0.288675*x84 - 0.096225*x86 =L= -2;

e68..  - 0.096225*x84 - 0.288675*x86 =L= -2;

e69..  - 0.288675*x88 - 0.096225*x90 =L= -2;

e70..  - 0.096225*x88 - 0.288675*x90 =L= -2;

e71..  - 0.577334*x92 - 0.192456*x94 =L= -2;

e72..  - 0.192448*x92 - 0.577356*x94 =L= -2;

e73..  - 0.577334*x96 - 0.192456*x98 =L= -2;

e74..  - 0.192448*x96 - 0.577356*x98 =L= -2;

e75..  - 0.577334*x100 - 0.192456*x102 =L= -2;

e76..  - 0.192448*x100 - 0.577356*x102 =L= -2;
...
i55.up = 100; 
i56.up = 100; 
x76.lo = 2.3094; x76.up = 6.9282; 
x77.lo = 2.3094; x77.up = 6.9282; 
x78.lo = 2.3094; x78.up = 6.9282; 
x79.lo = 2.3094; x79.up = 6.9282; 
x80.lo = 2.3094; x80.up = 6.9282; 
x82.lo = 2.3094; x82.up = 6.9282; 
x84.lo = 3.4641; x84.up = 10.3923; 
x86.lo = 3.4641; x86.up = 10.3923; 
x88.lo = 3.4641; x88.up = 10.3923; 
x90.lo = 3.4641; x90.up = 10.3923; 
x92.lo = 1.7321; x92.up = 5.1962; 
x94.lo = 1.7321; x94.up = 5.1962; 
x96.lo = 1.7321; x96.up = 5.1962; 
x98.lo = 1.7321; x98.up = 5.1962; 
x100.lo = 1.7321; x100.up = 5.1962; 
x102.lo = 1.7321; x102.up = 5.1962; 
