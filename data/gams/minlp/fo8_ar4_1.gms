...
e61..  - 0.5*x76 - 0.125*x78 =L= -2;

e62..  - 0.125*x76 - 0.5*x78 =L= -2;

e63..  - 0.5*x77 - 0.125*x79 =L= -2;

e64..  - 0.125*x77 - 0.5*x79 =L= -2;

e65..  - 0.5*x80 - 0.125*x82 =L= -2;

e66..  - 0.125*x80 - 0.5*x82 =L= -2;

e67..  - 0.333333*x84 - 0.083333*x86 =L= -2;

e68..  - 0.088417*x84 - 0.314167*x86 =L= -2;

e69..  - 0.333333*x88 - 0.083333*x90 =L= -2;

e70..  - 0.088417*x88 - 0.314167*x90 =L= -2;

e71..  - 0.666667*x92 - 0.166667*x94 =L= -2;

e72..  - 0.166667*x92 - 0.666667*x94 =L= -2;

e73..  - 0.666667*x96 - 0.166667*x98 =L= -2;

e74..  - 0.166667*x96 - 0.666667*x98 =L= -2;

e75..  - 0.666667*x100 - 0.166667*x102 =L= -2;

e76..  - 0.166667*x100 - 0.666667*x102 =L= -2;
...
x80.lo = 2; x80.up = 8; 
x82.lo = 2; x82.up = 8; 
x84.lo = 3; x84.up = 11.31; 
x86.lo = 3.183; x86.up = 12; 
x88.lo = 3; x88.up = 11.31; 
x90.lo = 3.183; x90.up = 12; 
x92.lo = 1.5; x92.up = 6; 
x94.lo = 1.5; x94.up = 6; 
x96.lo = 1.5; x96.up = 6; 
x98.lo = 1.5; x98.up = 6; 
x100.lo = 1.5; x100.up = 6; 
x102.lo = 1.5; x102.up = 6; 
