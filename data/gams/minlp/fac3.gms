...
e1..  - (276.28*sqr(x1 + x2 + x3 + x4 + x5 + x6 + x19 + x20 + x21 + x22 + x23
      + x24 + x37 + x38 + x39 + x40 + x41 + x42) + 792.912*sqr(x7 + x8 + x9 + 
     x10 + x11 + x12 + x25 + x26 + x27 + x28 + x29 + x30 + x43 + x44 + x45 + 
     x46 + x47 + x48) + 991.679*sqr(x13 + x14 + x15 + x16 + x17 + x18 + x31 + 
     x32 + x33 + x34 + x35 + x36 + x49 + x50 + x51 + x52 + x53 + x54) + 115.274
     *x1 + 98.5559*x2 + 142.777*x3 + 33.9886*x4 + 163.087*x5 + 10.4376*x6 + 
