$offlisting
*  MINLP written by GAMS Convert at 04/18/01 12:09:28
*  
*  Equation counts
*     Total       E       G       L       N       X
*        25       7       0      18       0       0
...
e24..  - (sqrt(i3*x5) + sqrt(i4*x6)) + b9 + 2*b10 + 3*b11 + 4*b12 + 5*b13
       + 6*b14 + 7*b15 + 8*b16 + b17 + 2*b18 + 3*b19 + 4*b20 + 5*b21 + 6*b22
       + 7*b23 + b24 + 2*b25 + 3*b26 + 4*b27 + b28 + 2*b29 + 3*b30 + 4*b31
       =L= -10;

e25..  - (sqrt(i3*x7) + sqrt(i4*x8)) + b9 + 2*b10 + 3*b11 + 4*b12 + 5*b13
       + 6*b14 + 7*b15 + 8*b16 + b17 + 2*b18 + 3*b19 + 4*b20 + 5*b21 + 6*b22
       + 7*b23 + b32 + 2*b33 + 3*b34 + b35 + 2*b36 + 3*b37 =L= -9;
