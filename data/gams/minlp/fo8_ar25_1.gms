$offlisting
*  MINLP written by GAMS Convert at 12/19/05 12:07:06
*  
*  Equation counts
*      Total        E        G        L        N        X        C
*        348        2        2      344        0        0        0
...
e61..  - 0.395288*x76 - 0.158112*x78 =L= -2;

e62..  - 0.158113*x76 - 0.395288*x78 =L= -2;

e63..  - 0.395288*x77 - 0.158112*x79 =L= -2;

e64..  - 0.158113*x77 - 0.395288*x79 =L= -2;

e65..  - 0.395288*x80 - 0.158112*x82 =L= -2;

e66..  - 0.158113*x80 - 0.395288*x82 =L= -2;

e67..  - 0.263525*x84 - 0.105408*x86 =L= -2;

e68..  - 0.10541*x84 - 0.263522*x86 =L= -2;

e69..  - 0.263525*x88 - 0.105408*x90 =L= -2;

e70..  - 0.10541*x88 - 0.263522*x90 =L= -2;

e71..  - 0.527037*x92 - 0.210822*x94 =L= -2;

e72..  - 0.210819*x92 - 0.527044*x94 =L= -2;

e73..  - 0.527037*x96 - 0.210822*x98 =L= -2;

e74..  - 0.210819*x96 - 0.527044*x98 =L= -2;

e75..  - 0.527037*x100 - 0.210822*x102 =L= -2;

e76..  - 0.210819*x100 - 0.527044*x102 =L= -2;
...
i55.up = 100; 
i56.up = 100; 
x76.lo = 2.5298; x76.up = 6.3246; 
x77.lo = 2.5298; x77.up = 6.3246; 
x78.lo = 2.5298; x78.up = 6.3246; 
x79.lo = 2.5298; x79.up = 6.3246; 
x80.lo = 2.5298; x80.up = 6.3246; 
x82.lo = 2.5298; x82.up = 6.3246; 
x84.lo = 3.7947; x84.up = 9.4868; 
x86.lo = 3.7947; x86.up = 9.4868; 
x88.lo = 3.7947; x88.up = 9.4868; 
x90.lo = 3.7947; x90.up = 9.4868; 
x92.lo = 1.8974; x92.up = 4.7434; 
x94.lo = 1.8974; x94.up = 4.7434; 
x96.lo = 1.8974; x96.up = 4.7434; 
x98.lo = 1.8974; x98.up = 4.7434; 
x100.lo = 1.8974; x100.up = 4.7434; 
x102.lo = 1.8974; x102.up = 4.7434; 
