$offlisting
*  MINLP written by GAMS Convert at 12/19/05 12:07:14
*  
*  Equation counts
*      Total        E        G        L        N        X        C
*        270        2        2      266        0        0        0
...
e47..  - 0.5*x68 - 0.125*x71 =L= -2;

e48..  - 0.125*x68 - 0.5*x71 =L= -2;

e49..  - 0.5*x69 - 0.125*x72 =L= -2;

e50..  - 0.125*x69 - 0.5*x72 =L= -2;

e51..  - 0.5*x74 - 0.125*x76 =L= -2;

e52..  - 0.125*x74 - 0.5*x76 =L= -2;

e53..  - 0.333333*x78 - 0.083333*x79 =L= -2;

e54..  - 0.117096*x78 - 0.237222*x79 =L= -2;

e55..  - 0.666667*x80 - 0.166667*x82 =L= -2;

e56..  - 0.166667*x80 - 0.666667*x82 =L= -2;

e57..  - 0.666667*x84 - 0.166667*x86 =L= -2;

e58..  - 0.166667*x84 - 0.666667*x86 =L= -2;

e59..  - 0.666667*x88 - 0.166667*x89 =L= -2;

e60..  - 0.166667*x88 - 0.666667*x89 =L= -2;
...
x74.lo = 2; x74.up = 8; 
x76.lo = 2; x76.up = 8; 
x78.lo = 3; x78.up = 8.54; 
x79.lo = 4.2155; x79.up = 12; 
x80.lo = 1.5; x80.up = 6; 
x82.lo = 1.5; x82.up = 6; 
x84.lo = 1.5; x84.up = 6; 
x86.lo = 1.5; x86.up = 6; 
