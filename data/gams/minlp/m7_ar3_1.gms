...
e48..  - 0.154304*x58 - 0.462907*x60 =L= -2;

e49..  - 0.5*x59 - 0.2*x61 =L= -2;

e50..  - 0.182575*x59 - 0.54772*x61 =L= -2;

e51..  - 0.555556*x62 - 0.2*x64 =L= -2;

e52..  - 0.192448*x62 - 0.577356*x64 =L= -2;

e53..  - 0.707114*x66 - 0.2357*x68 =L= -2;

e54..  - 0.235705*x66 - 0.7071*x68 =L= -2;

e55..  - 0.5*x70 - 0.2*x72 =L= -2;

e56..  - 0.182575*x70 - 0.54772*x72 =L= -2;

e57..  - 0.2*x74 - 0.2*x76 =L= -2;

e58..  - 0.115469*x74 - 0.346412*x76 =L= -2;

e59..  - 0.2*x78 - 0.2*x80 =L= -2;

e60..  - 0.115469*x78 - 0.346412*x80 =L= -2;
...
i41.up = 100; 
i42.up = 100; 
x58.lo = 2.8; x58.up = 6.4807; 
x59.lo = 2; x59.up = 5.4772; 
x60.lo = 2.1602; x60.up = 5; 
x61.lo = 1.8257; x61.up = 5; 
x62.lo = 1.8; x62.up = 5.1962; 
x64.lo = 1.7321; x64.up = 5; 
x66.lo = 1.4142; x66.up = 4.2426; 
x68.lo = 1.4142; x68.up = 4.2426; 
x70.lo = 2; x70.up = 5.4772; 
x72.lo = 1.8257; x72.up = 5; 
x74.lo = 5; x74.up = 8.6603; 
x76.lo = 2.8868; x76.up = 5; 
x78.lo = 5; x78.up = 8.6603; 
x80.lo = 2.8868; x80.up = 5; 
