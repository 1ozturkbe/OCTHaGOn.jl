$offlisting
*  MINLP written by GAMS Convert at 10/26/04 14:09:25
*  
*  Equation counts
*      Total        E        G        L        N        X        C
*        212        1        0      211        0        0        0
...
e1..    objvar - 5*x48 - 5*x49 - x54 - x55 - 3*x58 - 3*x59 - x64 - x65 - 2*x66
...
x86.lo = 1.7889; x86.up = 8.54; 
x87.lo = 1.7889; x87.up = 8.54; 
x88.lo = 1.7889; x88.up = 8.54; 
x89.lo = 2.7692; x89.up = 8.5399; 
x90.lo = 1.3416; x90.up = 6.7082; 
x91.lo = 1.3416; x91.up = 6.7082; 
x92.lo = 1.3416; x92.up = 6.7082; 
x93.fx = 8.54; 
x94.lo = 1.8735; x94.up = 8.944; 
x95.lo = 1.8735; x95.up = 8.944; 
x96.lo = 1.8735; x96.up = 8.944; 
x97.lo = 4.2155; x97.up = 13; 
x98.lo = 1.3416; x98.up = 6.7082; 
x99.lo = 1.3416; x99.up = 6.7082; 
