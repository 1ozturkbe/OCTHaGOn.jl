$offlisting
*  MINLP written by GAMS Convert at 05/01/01 16:07:47
*  
*  Equation counts
*     Total       E       G       L       N       X
*       318     234       0      84       0       0
...
e42.. 0.705*x85*x1 + 0.25*x91*x7 - x1*x169 =E= 0;

e43.. 0.705*x86*x2 + 0.25*x92*x8 - x2*x170 =E= 0;

e44.. 0.705*x87*x3 + 0.25*x93*x9 - x3*x171 =E= 0;

e45.. 0.705*x88*x4 + 0.25*x94*x10 - x4*x172 =E= 0;

e46.. 0.705*x89*x5 + 0.25*x95*x11 - x5*x173 =E= 0;

e47.. 0.705*x90*x6 + 0.25*x96*x12 - x6*x174 =E= 0;
...
e51.. 0.125*x88*x4 + 0.625*x94*x10 + 0.125*x100*x16 + 0.08*x124*x40 + 0.045*
      x130*x46 - x10*x172 =E= 0;

e52.. 0.125*x89*x5 + 0.625*x95*x11 + 0.125*x101*x17 + 0.08*x125*x41 + 0.045*
      x131*x47 - x11*x173 =E= 0;

e53.. 0.125*x90*x6 + 0.625*x96*x12 + 0.125*x102*x18 + 0.08*x126*x42 + 0.045*
      x132*x48 - x12*x174 =E= 0;

e54.. 0.125*x91*x7 + 0.58*x97*x13 + 0.125*x103*x19 + 0.045*x121*x37 + 0.08*x127
      *x43 + 0.045*x133*x49 - x13*x169 =E= 0;

e55.. 0.125*x92*x8 + 0.58*x98*x14 + 0.125*x104*x20 + 0.045*x122*x38 + 0.08*x128
      *x44 + 0.045*x134*x50 - x14*x170 =E= 0;

e56.. 0.125*x93*x9 + 0.58*x99*x15 + 0.125*x105*x21 + 0.045*x123*x39 + 0.08*x129
      *x45 + 0.045*x135*x51 - x15*x171 =E= 0;

e57.. 0.125*x94*x10 + 0.58*x100*x16 + 0.125*x106*x22 + 0.045*x124*x40 + 0.08*
      x130*x46 + 0.045*x136*x52 - x16*x172 =E= 0;

e58.. 0.125*x95*x11 + 0.58*x101*x17 + 0.125*x107*x23 + 0.045*x125*x41 + 0.08*
      x131*x47 + 0.045*x137*x53 - x17*x173 =E= 0;

e59.. 0.125*x96*x12 + 0.58*x102*x18 + 0.125*x108*x24 + 0.045*x126*x42 + 0.08*
      x132*x48 + 0.045*x138*x54 - x18*x174 =E= 0;

e60.. 0.125*x97*x13 + 0.58*x103*x19 + 0.125*x109*x25 + 0.045*x127*x43 + 0.08*
      x133*x49 + 0.045*x139*x55 - x19*x169 =E= 0;

e61.. 0.125*x98*x14 + 0.58*x104*x20 + 0.125*x110*x26 + 0.045*x128*x44 + 0.08*
      x134*x50 + 0.045*x140*x56 - x20*x170 =E= 0;

e62.. 0.125*x99*x15 + 0.58*x105*x21 + 0.125*x111*x27 + 0.045*x129*x45 + 0.08*
      x135*x51 + 0.045*x141*x57 - x21*x171 =E= 0;

e63.. 0.125*x100*x16 + 0.58*x106*x22 + 0.125*x112*x28 + 0.045*x130*x46 + 0.08*
      x136*x52 + 0.045*x142*x58 - x22*x172 =E= 0;

e64.. 0.125*x101*x17 + 0.58*x107*x23 + 0.125*x113*x29 + 0.045*x131*x47 + 0.08*
      x137*x53 + 0.045*x143*x59 - x23*x173 =E= 0;

e65.. 0.125*x102*x18 + 0.58*x108*x24 + 0.125*x114*x30 + 0.045*x132*x48 + 0.08*
      x138*x54 + 0.045*x144*x60 - x24*x174 =E= 0;

e66.. 0.125*x103*x19 + 0.58*x109*x25 + 0.125*x115*x31 + 0.045*x133*x49 + 0.08*
      x139*x55 - x25*x169 =E= 0;

e67.. 0.125*x104*x20 + 0.58*x110*x26 + 0.125*x116*x32 + 0.045*x134*x50 + 0.08*
      x140*x56 - x26*x170 =E= 0;

e68.. 0.125*x105*x21 + 0.58*x111*x27 + 0.125*x117*x33 + 0.045*x135*x51 + 0.08*
      x141*x57 - x27*x171 =E= 0;

e69.. 0.125*x106*x22 + 0.58*x112*x28 + 0.125*x118*x34 + 0.045*x136*x52 + 0.08*
      x142*x58 - x28*x172 =E= 0;

e70.. 0.125*x107*x23 + 0.58*x113*x29 + 0.125*x119*x35 + 0.045*x137*x53 + 0.08*
      x143*x59 - x29*x173 =E= 0;

e71.. 0.125*x108*x24 + 0.58*x114*x30 + 0.125*x120*x36 + 0.045*x138*x54 + 0.08*
      x144*x60 - x30*x174 =E= 0;

e72.. 0.125*x109*x25 + 0.58*x115*x31 + 0.045*x139*x55 - x31*x169 =E= 0;

e73.. 0.125*x110*x26 + 0.58*x116*x32 + 0.045*x140*x56 - x32*x170 =E= 0;

e74.. 0.125*x111*x27 + 0.58*x117*x33 + 0.045*x141*x57 - x33*x171 =E= 0;

e75.. 0.125*x112*x28 + 0.58*x118*x34 + 0.045*x142*x58 - x34*x172 =E= 0;

e76.. 0.125*x113*x29 + 0.58*x119*x35 + 0.045*x143*x59 - x35*x173 =E= 0;

e77.. 0.125*x114*x30 + 0.58*x120*x36 + 0.045*x144*x60 - x36*x174 =E= 0;

e78.. 0.045*x85*x1 + 0.16*x91*x7 + 0.5*x121*x37 + 0.16*x127*x43 + 0.045*x145*
      x61 - x37*x169 =E= 0;

e79.. 0.045*x86*x2 + 0.16*x92*x8 + 0.5*x122*x38 + 0.16*x128*x44 + 0.045*x146*
      x62 - x38*x170 =E= 0;

e80.. 0.045*x87*x3 + 0.16*x93*x9 + 0.5*x123*x39 + 0.16*x129*x45 + 0.045*x147*
      x63 - x39*x171 =E= 0;
...
e84.. 0.045*x91*x7 + 0.08*x97*x13 + 0.045*x103*x19 + 0.08*x121*x37 + 0.545*x127
      *x43 + 0.08*x133*x49 + 0.08*x145*x61 + 0.045*x151*x67 - x43*x169 =E= 0;

e85.. 0.045*x92*x8 + 0.08*x98*x14 + 0.045*x104*x20 + 0.08*x122*x38 + 0.545*x128
      *x44 + 0.08*x134*x50 + 0.08*x146*x62 + 0.045*x152*x68 - x44*x170 =E= 0;

e86.. 0.045*x93*x9 + 0.08*x99*x15 + 0.045*x105*x21 + 0.08*x123*x39 + 0.545*x129
      *x45 + 0.08*x135*x51 + 0.08*x147*x63 + 0.045*x153*x69 - x45*x171 =E= 0;

e87.. 0.045*x94*x10 + 0.08*x100*x16 + 0.045*x106*x22 + 0.08*x124*x40 + 0.545*
      x130*x46 + 0.08*x136*x52 + 0.08*x148*x64 + 0.045*x154*x70 - x46*x172
       =E= 0;

e88.. 0.045*x95*x11 + 0.08*x101*x17 + 0.045*x107*x23 + 0.08*x125*x41 + 0.545*
      x131*x47 + 0.08*x137*x53 + 0.08*x149*x65 + 0.045*x155*x71 - x47*x173
       =E= 0;

e89.. 0.045*x96*x12 + 0.08*x102*x18 + 0.045*x108*x24 + 0.08*x126*x42 + 0.545*
      x132*x48 + 0.08*x138*x54 + 0.08*x150*x66 + 0.045*x156*x72 - x48*x174
       =E= 0;
...
e93.. 0.045*x100*x16 + 0.08*x106*x22 + 0.045*x112*x28 + 0.08*x130*x46 + 0.5*
      x136*x52 + 0.08*x142*x58 + 0.045*x148*x64 + 0.08*x154*x70 + 0.045*x160*
      x76 - x52*x172 =E= 0;

e94.. 0.045*x101*x17 + 0.08*x107*x23 + 0.045*x113*x29 + 0.08*x131*x47 + 0.5*
      x137*x53 + 0.08*x143*x59 + 0.045*x149*x65 + 0.08*x155*x71 + 0.045*x161*
      x77 - x53*x173 =E= 0;

e95.. 0.045*x102*x18 + 0.08*x108*x24 + 0.045*x114*x30 + 0.08*x132*x48 + 0.5*
      x138*x54 + 0.08*x144*x60 + 0.045*x150*x66 + 0.08*x156*x72 + 0.045*x162*
      x78 - x54*x174 =E= 0;

e96.. 0.045*x103*x19 + 0.08*x109*x25 + 0.045*x115*x31 + 0.08*x133*x49 + 0.5*
      x139*x55 + 0.045*x151*x67 + 0.08*x157*x73 - x55*x169 =E= 0;

e97.. 0.045*x104*x20 + 0.08*x110*x26 + 0.045*x116*x32 + 0.08*x134*x50 + 0.5*
      x140*x56 + 0.045*x152*x68 + 0.08*x158*x74 - x56*x170 =E= 0;

e98.. 0.045*x105*x21 + 0.08*x111*x27 + 0.045*x117*x33 + 0.08*x135*x51 + 0.5*
      x141*x57 + 0.045*x153*x69 + 0.08*x159*x75 - x57*x171 =E= 0;

e99.. 0.045*x106*x22 + 0.08*x112*x28 + 0.045*x118*x34 + 0.08*x136*x52 + 0.5*
      x142*x58 + 0.045*x154*x70 + 0.08*x160*x76 - x58*x172 =E= 0;

e100.. 0.045*x107*x23 + 0.08*x113*x29 + 0.045*x119*x35 + 0.08*x137*x53 + 0.5*
       x143*x59 + 0.045*x155*x71 + 0.08*x161*x77 - x59*x173 =E= 0;

e101.. 0.045*x108*x24 + 0.08*x114*x30 + 0.045*x120*x36 + 0.08*x138*x54 + 0.5*
       x144*x60 + 0.045*x156*x72 + 0.08*x162*x78 - x60*x174 =E= 0;

e102.. 0.045*x121*x37 + 0.125*x127*x43 + 0.045*x133*x49 + 0.5*x145*x61 + 0.16*
       x151*x67 + 0.045*x163*x79 - x61*x169 =E= 0;

e103.. 0.045*x122*x38 + 0.125*x128*x44 + 0.045*x134*x50 + 0.5*x146*x62 + 0.16*
       x152*x68 + 0.045*x164*x80 - x62*x170 =E= 0;

e104.. 0.045*x123*x39 + 0.125*x129*x45 + 0.045*x135*x51 + 0.5*x147*x63 + 0.16*
       x153*x69 + 0.045*x165*x81 - x63*x171 =E= 0;

e105.. 0.045*x124*x40 + 0.125*x130*x46 + 0.045*x136*x52 + 0.5*x148*x64 + 0.16*
       x154*x70 + 0.045*x166*x82 - x64*x172 =E= 0;

e106.. 0.045*x125*x41 + 0.125*x131*x47 + 0.045*x137*x53 + 0.5*x149*x65 + 0.16*
       x155*x71 + 0.045*x167*x83 - x65*x173 =E= 0;

e107.. 0.045*x126*x42 + 0.125*x132*x48 + 0.045*x138*x54 + 0.5*x150*x66 + 0.16*
       x156*x72 + 0.045*x168*x84 - x66*x174 =E= 0;

e108.. 0.045*x127*x43 + 0.08*x133*x49 + 0.045*x139*x55 + 0.08*x145*x61 + 0.545*
       x151*x67 + 0.08*x157*x73 + 0.08*x163*x79 - x67*x169 =E= 0;

e109.. 0.045*x128*x44 + 0.08*x134*x50 + 0.045*x140*x56 + 0.08*x146*x62 + 0.545*
       x152*x68 + 0.08*x158*x74 + 0.08*x164*x80 - x68*x170 =E= 0;

e110.. 0.045*x129*x45 + 0.08*x135*x51 + 0.045*x141*x57 + 0.08*x147*x63 + 0.545*
       x153*x69 + 0.08*x159*x75 + 0.08*x165*x81 - x69*x171 =E= 0;

e111.. 0.045*x130*x46 + 0.08*x136*x52 + 0.045*x142*x58 + 0.08*x148*x64 + 0.545*
       x154*x70 + 0.08*x160*x76 + 0.08*x166*x82 - x70*x172 =E= 0;

e112.. 0.045*x131*x47 + 0.08*x137*x53 + 0.045*x143*x59 + 0.08*x149*x65 + 0.545*
       x155*x71 + 0.08*x161*x77 + 0.08*x167*x83 - x71*x173 =E= 0;

e113.. 0.045*x132*x48 + 0.08*x138*x54 + 0.045*x144*x60 + 0.08*x150*x66 + 0.545*
       x156*x72 + 0.08*x162*x78 + 0.08*x168*x84 - x72*x174 =E= 0;

e114.. 0.045*x133*x49 + 0.08*x139*x55 + 0.08*x151*x67 + 0.5*x157*x73 + 0.045*
       x163*x79 - x73*x169 =E= 0;

e115.. 0.045*x134*x50 + 0.08*x140*x56 + 0.08*x152*x68 + 0.5*x158*x74 + 0.045*
       x164*x80 - x74*x170 =E= 0;

e116.. 0.045*x135*x51 + 0.08*x141*x57 + 0.08*x153*x69 + 0.5*x159*x75 + 0.045*
       x165*x81 - x75*x171 =E= 0;

e117.. 0.045*x136*x52 + 0.08*x142*x58 + 0.08*x154*x70 + 0.5*x160*x76 + 0.045*
       x166*x82 - x76*x172 =E= 0;

e118.. 0.045*x137*x53 + 0.08*x143*x59 + 0.08*x155*x71 + 0.5*x161*x77 + 0.045*
       x167*x83 - x77*x173 =E= 0;

e119.. 0.045*x138*x54 + 0.08*x144*x60 + 0.08*x156*x72 + 0.5*x162*x78 + 0.045*
       x168*x84 - x78*x174 =E= 0;

e120.. 0.045*x145*x61 + 0.125*x151*x67 + 0.5*x163*x79 - x79*x169 =E= 0;

e121.. 0.045*x146*x62 + 0.125*x152*x68 + 0.5*x164*x80 - x80*x170 =E= 0;

e122.. 0.045*x147*x63 + 0.125*x153*x69 + 0.5*x165*x81 - x81*x171 =E= 0;

e123.. 0.045*x148*x64 + 0.125*x154*x70 + 0.5*x166*x82 - x82*x172 =E= 0;

e124.. 0.045*x149*x65 + 0.125*x155*x71 + 0.5*x167*x83 - x83*x173 =E= 0;

e125.. 0.045*x150*x66 + 0.125*x156*x72 + 0.5*x168*x84 - x84*x174 =E= 0;

e126..  - (x85 - 0.1862*x85*x1) + x86 =E= 0;

e127..  - (x86 - 0.1862*x86*x2) + x87 =E= 0;

e128..  - (x87 - 0.1862*x87*x3) + x88 =E= 0;

e129..  - (x88 - 0.1862*x88*x4) + x89 =E= 0;

e130..  - (x89 - 0.1862*x89*x5) + x90 =E= 0;

e131..  - (x91 - 0.1862*x91*x7) + x92 =E= 0;

e132..  - (x92 - 0.1862*x92*x8) + x93 =E= 0;

e133..  - (x93 - 0.1862*x93*x9) + x94 =E= 0;

e134..  - (x94 - 0.1862*x94*x10) + x95 =E= 0;

e135..  - (x95 - 0.1862*x95*x11) + x96 =E= 0;

e136..  - (x97 - 0.1862*x97*x13) + x98 =E= 0;

e137..  - (x98 - 0.1862*x98*x14) + x99 =E= 0;

e138..  - (x99 - 0.1862*x99*x15) + x100 =E= 0;

e139..  - (x100 - 0.1862*x100*x16) + x101 =E= 0;

e140..  - (x101 - 0.1862*x101*x17) + x102 =E= 0;

e141..  - (x103 - 0.1862*x103*x19) + x104 =E= 0;

e142..  - (x104 - 0.1862*x104*x20) + x105 =E= 0;

e143..  - (x105 - 0.1862*x105*x21) + x106 =E= 0;

e144..  - (x106 - 0.1862*x106*x22) + x107 =E= 0;

e145..  - (x107 - 0.1862*x107*x23) + x108 =E= 0;

e146..  - (x109 - 0.1862*x109*x25) + x110 =E= 0;

e147..  - (x110 - 0.1862*x110*x26) + x111 =E= 0;

e148..  - (x111 - 0.1862*x111*x27) + x112 =E= 0;

e149..  - (x112 - 0.1862*x112*x28) + x113 =E= 0;

e150..  - (x113 - 0.1862*x113*x29) + x114 =E= 0;

e151..  - (x115 - 0.1862*x115*x31) + x116 =E= 0;

e152..  - (x116 - 0.1862*x116*x32) + x117 =E= 0;

e153..  - (x117 - 0.1862*x117*x33) + x118 =E= 0;

e154..  - (x118 - 0.1862*x118*x34) + x119 =E= 0;

e155..  - (x119 - 0.1862*x119*x35) + x120 =E= 0;

e156..  - (x121 - 0.1862*x121*x37) + x122 =E= 0;

e157..  - (x122 - 0.1862*x122*x38) + x123 =E= 0;

e158..  - (x123 - 0.1862*x123*x39) + x124 =E= 0;

e159..  - (x124 - 0.1862*x124*x40) + x125 =E= 0;

e160..  - (x125 - 0.1862*x125*x41) + x126 =E= 0;

e161..  - (x127 - 0.1862*x127*x43) + x128 =E= 0;

e162..  - (x128 - 0.1862*x128*x44) + x129 =E= 0;

e163..  - (x129 - 0.1862*x129*x45) + x130 =E= 0;

e164..  - (x130 - 0.1862*x130*x46) + x131 =E= 0;

e165..  - (x131 - 0.1862*x131*x47) + x132 =E= 0;

e166..  - (x133 - 0.1862*x133*x49) + x134 =E= 0;

e167..  - (x134 - 0.1862*x134*x50) + x135 =E= 0;

e168..  - (x135 - 0.1862*x135*x51) + x136 =E= 0;

e169..  - (x136 - 0.1862*x136*x52) + x137 =E= 0;

e170..  - (x137 - 0.1862*x137*x53) + x138 =E= 0;

e171..  - (x139 - 0.1862*x139*x55) + x140 =E= 0;

e172..  - (x140 - 0.1862*x140*x56) + x141 =E= 0;

e173..  - (x141 - 0.1862*x141*x57) + x142 =E= 0;

e174..  - (x142 - 0.1862*x142*x58) + x143 =E= 0;

e175..  - (x143 - 0.1862*x143*x59) + x144 =E= 0;

e176..  - (x145 - 0.1862*x145*x61) + x146 =E= 0;

e177..  - (x146 - 0.1862*x146*x62) + x147 =E= 0;

e178..  - (x147 - 0.1862*x147*x63) + x148 =E= 0;

e179..  - (x148 - 0.1862*x148*x64) + x149 =E= 0;

e180..  - (x149 - 0.1862*x149*x65) + x150 =E= 0;

e181..  - (x151 - 0.1862*x151*x67) + x152 =E= 0;

e182..  - (x152 - 0.1862*x152*x68) + x153 =E= 0;

e183..  - (x153 - 0.1862*x153*x69) + x154 =E= 0;

e184..  - (x154 - 0.1862*x154*x70) + x155 =E= 0;

e185..  - (x155 - 0.1862*x155*x71) + x156 =E= 0;

e186..  - (x157 - 0.1862*x157*x73) + x158 =E= 0;

e187..  - (x158 - 0.1862*x158*x74) + x159 =E= 0;

e188..  - (x159 - 0.1862*x159*x75) + x160 =E= 0;

e189..  - (x160 - 0.1862*x160*x76) + x161 =E= 0;

e190..  - (x161 - 0.1862*x161*x77) + x162 =E= 0;

e191..  - (x163 - 0.1862*x163*x79) + x164 =E= 0;

e192..  - (x164 - 0.1862*x164*x80) + x165 =E= 0;

e193..  - (x165 - 0.1862*x165*x81) + x166 =E= 0;

e194..  - (x166 - 0.1862*x166*x82) + x167 =E= 0;

e195..  - (x167 - 0.1862*x167*x83) + x168 =E= 0;
