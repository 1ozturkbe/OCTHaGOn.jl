$offlisting
*  MINLP written by GAMS Convert at 12/19/05 12:07:08
*  
*  Equation counts
*      Total        E        G        L        N        X        C
*        270        2        2      266        0        0        0
...
e48..  - 0.119523*x58 - 0.597614*x60 =L= -2;

e49..  - 0.5*x59 - 0.2*x61 =L= -2;

e50..  - 0.141421*x59 - 0.70711*x61 =L= -2;

e51..  - 0.555556*x62 - 0.2*x64 =L= -2;

e52..  - 0.149071*x62 - 0.745356*x64 =L= -2;

e53..  - 0.833333*x66 - 0.2*x68 =L= -2;

e54..  - 0.182575*x66 - 0.912867*x68 =L= -2;

e55..  - 0.5*x70 - 0.2*x72 =L= -2;

e56..  - 0.141421*x70 - 0.70711*x72 =L= -2;

e57..  - 0.2*x74 - 0.2*x76 =L= -2;

e58..  - 0.089443*x74 - 0.447212*x76 =L= -2;

e59..  - 0.2*x78 - 0.2*x80 =L= -2;

e60..  - 0.089443*x78 - 0.447212*x80 =L= -2;
...
i41.up = 100; 
i42.up = 100; 
x58.lo = 2.8; x58.up = 8.3666; 
x59.lo = 2; x59.up = 7.0711; 
x60.lo = 1.6733; x60.up = 5; 
x61.lo = 1.4142; x61.up = 5; 
x62.lo = 1.8; x62.up = 6.7082; 
x64.lo = 1.3416; x64.up = 5; 
x66.lo = 1.2; x66.up = 5.4772; 
x68.lo = 1.0954; x68.up = 5; 
x70.lo = 2; x70.up = 7.0711; 
x72.lo = 1.4142; x72.up = 5; 
x74.lo = 5; x74.up = 11.1803; 
x76.lo = 2.2361; x76.up = 5; 
x78.lo = 5; x78.up = 11.1803; 
x80.lo = 2.2361; x80.up = 5; 
