$offlisting
*  MINLP written by GAMS Convert at 12/19/05 12:07:15
*  
*  Equation counts
*      Total        E        G        L        N        X        C
*        270        2        2      266        0        0        0
...
e47..  - 0.559003*x68 - 0.111806*x71 =L= -2;

e48..  - 0.117096*x68 - 0.53375*x71 =L= -2;

e49..  - 0.559003*x69 - 0.111806*x72 =L= -2;

e50..  - 0.117096*x69 - 0.53375*x72 =L= -2;

e51..  - 0.559003*x74 - 0.111806*x76 =L= -2;

e52..  - 0.117096*x74 - 0.53375*x76 =L= -2;

e53..  - 0.361115*x78 - 0.076922*x79 =L= -2;

e54..  - 0.117096*x78 - 0.237222*x79 =L= -2;

e55..  - 0.745379*x80 - 0.149067*x82 =L= -2;

e56..  - 0.149071*x80 - 0.745356*x82 =L= -2;

e57..  - 0.745379*x84 - 0.149067*x86 =L= -2;

e58..  - 0.149071*x84 - 0.745356*x86 =L= -2;

e59..  - 0.745379*x88 - 0.149067*x89 =L= -2;

e60..  - 0.149071*x88 - 0.745356*x89 =L= -2;
...
i41.up = 100; 
i42.up = 100; 
x68.lo = 1.7889; x68.up = 8.54; 
x69.lo = 1.7889; x69.up = 8.54; 
x71.lo = 1.8735; x71.up = 8.9443; 
x72.lo = 1.8735; x72.up = 8.9443; 
x74.lo = 1.7889; x74.up = 8.54; 
x76.lo = 1.8735; x76.up = 8.9443; 
x78.lo = 2.7692; x78.up = 8.54; 
x79.lo = 4.2155; x79.up = 13; 
x80.lo = 1.3416; x80.up = 6.7082; 
x82.lo = 1.3416; x82.up = 6.7082; 
x84.lo = 1.3416; x84.up = 6.7082; 
x86.lo = 1.3416; x86.up = 6.7082; 
x88.lo = 1.3416; x88.up = 6.7082; 
x89.lo = 1.3416; x89.up = 6.7082; 
