...
Positive Variables x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18
          ,x19,x20,x21,x22,x23,x24,x25,x26,x27,x28,x29,x31,x33,x34,x35,x36,x37
...
e1..  - (0.4*((0.003375*x30 - 1.15398)*x2 + (0.000893*x31 - 0.30630793)*x3 + (
     0.004458*x32 - 1.57608132)*x4 + (0.003176*x33 - 1.08593792)*x5 + 
...
e2..  - (0.666666666666667*sqrt((x30 - 305)*(x30 - 325)) + 0.333333333333333*
     x30) + x38 - x42 + x46 =E= -105;

e3..  - (0.666666666666667*sqrt((x31 - 305)*(x31 - 325)) + 0.333333333333333*
     x31) + x39 - x43 + x47 =E= -105;

e4..  - (0.666666666666667*sqrt((x32 - 305)*(x32 - 325)) + 0.333333333333333*
     x32) + x40 - x44 + x48 =E= -105;

e5..  - (0.666666666666667*sqrt((x33 - 305)*(x33 - 325)) + 0.333333333333333*
