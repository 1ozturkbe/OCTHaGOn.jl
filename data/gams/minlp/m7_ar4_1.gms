...
e48..  - 0.133631*x58 - 0.534521*x60 =L= -2;

e49..  - 0.5*x59 - 0.2*x61 =L= -2;

e50..  - 0.158113*x59 - 0.63246*x61 =L= -2;

e51..  - 0.555556*x62 - 0.2*x64 =L= -2;

e52..  - 0.166667*x62 - 0.666667*x64 =L= -2;

e53..  - 0.816526*x66 - 0.204117*x68 =L= -2;

e54..  - 0.204123*x66 - 0.8165*x68 =L= -2;

e55..  - 0.5*x70 - 0.2*x72 =L= -2;

e56..  - 0.158113*x70 - 0.63246*x72 =L= -2;

e57..  - 0.2*x74 - 0.2*x76 =L= -2;

e58..  - 0.1*x74 - 0.4*x76 =L= -2;

e59..  - 0.2*x78 - 0.2*x80 =L= -2;

e60..  - 0.1*x78 - 0.4*x80 =L= -2;
...
i41.up = 100; 
i42.up = 100; 
x58.lo = 2.8; x58.up = 7.4833; 
x59.lo = 2; x59.up = 6.3246; 
x60.lo = 1.8708; x60.up = 5; 
x61.lo = 1.5811; x61.up = 5; 
x62.lo = 1.8; x62.up = 6; 
x64.lo = 1.5; x64.up = 5; 
x66.lo = 1.2247; x66.up = 4.899; 
x68.lo = 1.2247; x68.up = 4.899; 
x70.lo = 2; x70.up = 6.3246; 
x72.lo = 1.5811; x72.up = 5; 
x74.lo = 5; x74.up = 10; 
x76.lo = 2.5; x76.up = 5; 
x78.lo = 5; x78.up = 10; 
x80.lo = 2.5; x80.up = 5; 
