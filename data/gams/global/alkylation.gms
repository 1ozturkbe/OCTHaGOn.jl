...
e3..  - 98000*x3/(x4*x9 + 1000*x3) + x6 =E= 0;

e4..  - (x2 + x5)/x1 + x8 =E= 0;

e5.. (1.12 + 0.13167*x8 - 0.00667*x8**2)*x1 - 0.99*x4 =G= 0;

e6..  - (1.12 + 0.13167*x8 - 0.00667*x8**2)*x1 + 1.01010101010101*x4 =G= 0;
...
x1.lo = 1E-6; x1.up = 2000; 
x2.lo = 1E-6; x2.up = 16000; 
x3.lo = 1E-6; x3.up = 120; 
x4.lo = 1E-6; x4.up = 5000; 
x5.lo = 1E-6; x5.up = 2000; 
x6.lo = 85; x6.up = 93; 
x7.lo = 90; x7.up = 95; 
x8.lo = 3; x8.up = 12; 
x9.lo = 0.01; x9.up = 4; 
