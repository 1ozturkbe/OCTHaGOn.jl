*  NLP written by GAMS Convert at 08/30/02 10:31:04
*  
*  Equation counts
*     Total       E       G       L       N       X       C
*        11       1       0      10       0       0       0
...
e11..  - (2*x1 - 0.5*sqr(x1) - 0.5*sqr(x2) + 2*x2 - 0.5*sqr(x3) + 2*x3 - 0.5*
      sqr(x4) + 2*x4 - 0.5*sqr(x5) + 2*x5 - 0.5*sqr(x6) + 2*x6 - 0.5*sqr(x7) + 
      2*x7 - 0.5*sqr(x8) + 2*x8 - 0.5*sqr(x9) + 2*x9 - 0.5*sqr(x10) + 2*x10 - 
      0.5*sqr(x11) + 2*x11 - 0.5*sqr(x12) + 2*x12 - 0.5*sqr(x13) + 2*x13 - 0.5*
      sqr(x14) + 2*x14 - 0.5*sqr(x15) + 2*x15 - 0.5*sqr(x16) + 2*x16 - 0.5*sqr(
      x17) + 2*x17 - 0.5*sqr(x18) + 2*x18 - 0.5*sqr(x19) + 2*x19 - 0.5*sqr(x20)
       + 2*x20) + objvar =E= 0;
